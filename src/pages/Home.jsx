  ...
  return (
    <section className="max-w-7xl px-12 mx-auto">
      <div className=" font-medium text-2xl text-center">
        <h1 className="font-bold text-gray-800 text-[32px]">Community Generated images</h1>
        <p className="mt-2 text-gray-600">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
      </div>
      <div className="mt-10">
        <FormField />
      </div>
